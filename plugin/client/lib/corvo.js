let wasm_bindgen = (function(exports) {
     ...
     * @param {number} explore_secs
     * @param {number} compress_secs
     * @param {bigint} seed
     * @param {number} min_separation
     * @param {Function} on_report
     * @returns {string}
     */
    function nest(instance_json, explore_secs, compress_secs, seed, min_separation, on_report) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(instance_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.nest(ptr0, len0, explore_secs, compress_secs, seed, min_separation, on_report);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
